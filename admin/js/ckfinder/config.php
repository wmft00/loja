...
function CheckAuthentication()
{
    ...
    //if(isset($_SESSION['permisso']) && $_SESSION['permisso'] == 1){
        return true;
    //}else return false;
}
...
*/
$baseUrl = 'http://www1.ows.com.br/sistema2017/upload/ckeditor/';
...
If enabled, characters with diactric marks, like å, ä, ö, ć, �*/