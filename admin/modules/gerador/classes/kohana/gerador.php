...
Class Model_' . ucwords(strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela'])))) . ' extends ORM {
    ...
    protected $_primary_key = "' . $carcEst . '_'.$id[0].'";
        ';
                    if(in_array("DATE", $post["fTipo"])){
                        $max = count($post['fTipo']);
                        for ($i = 0; $i < $max; $i++) {
                            //SE TIPO FOR DATE, ORDER BY IT
                            if ($post["fTipo"][$i] == "DATE") {
    $model .= 'protected $_sorting = array("' . $carc . '_'.strtoupper($this->trataTxt($post['fCampo'][$i])).'" => "desc");';
                            break;
                            }
                        }
                    }else{
    $model .= 'protected $_sorting = array("' . $carc . '_'.$id[0].'" => "asc");';
                    }
                }else{
            $model .= '
    ...
    public function action_edit(){
        ...
        if($id){
            ...
            if ($'.strtolower(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))).') {
                $view->'.strtolower(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))).' = "<div class=\'form-group\'>
                        <label class=\'col-sm-2 control-label\'>Excluir '.ucwords(($post["fCampo"][$i])).'</label>
...
';
    ...
    if($post["fRegistro"] == "D" or $post["fRegistro"] == "O"){
        ...
        if (';
                    ...
                    //FECHA O TESTE DO IF
                    $controlador .= '){
            $this->action_index("<p class=\'res-alert warning\'>Existem '.$itens.' cadastrados nessa '.$post['fTabela'].'! Nenhuma alteração realizada!</p>", true);
        }else{
                        ';
                    }
                }
...
//Adiciona um novo texto
            $edicao = '<div class="row"><section id="formulario">
    <div class="infos">
    ...
    $edicao .= '
            <form action="<?php echo url::base() ?>' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '/save" class="form-horizontal" id="formEdit" name="formEdit" method="post"';
    
            //SE TEM ARQUIVO NO ARRAY, ADICIONA O ENCTYPE
            if(in_array("ARQUIVO", $post["fTipo"]) OR in_array("IMAGEM", $post["fTipo"])){
    ...
    ';
                            ...
                            switch ($post['fTipo'][$i]) {
                                case "VARCHAR":
                                    ...
                                    if (strpos(strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))), "FONE") 
                                        ...
                                        $classediv = 'input-group';
                                        $iconecampo = '<div class="input-group-addon"><i class="fa fa-phone"></i></div>';
                                    }
                                    
                                    $edicao .=
                                    '
        <div class="form-group">
            <label for="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" class="col-sm-2 control-label">' . ucwords(($post['fCampo'][$i])) . $asterisco . '</label>';

            $edicao .= '
            <div class="'.$classediv.'">
                '.$iconecampo.'
                <input type="text" '.$validar.' '.$disabled.' class="form-control '.$small.' '.$fone.'" placeholder="' . ucwords(($post['fCampo'][$i])) . '" value="<?php if($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . ') echo $' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '["' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '"] ?>" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" '.$regraFone.'>';
        ...
        <div class="form-group">
            ...
            $edicao .= '
            <div class="col-sm-10">
                <input type="password" '.$disabled.' class="form-control" placeholder="' . ucwords(($post['fCampo'][$i])) . '" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '"
        ...
        <div class="form-group">
            <label for="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '_C" class="col-sm-2 control-label">Confirmar ' . ucwords(($post['fCampo'][$i])) . $asterisco . '</label>';

            $edicao .= '
            <div class="col-sm-10">
                <input type="password" '.$disabled.' class="form-control" placeholder="' . ucwords(($post['fCampo'][$i])) . '" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '_C" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '_C"
        ...
        <div class="form-group">
            ...
            $edicao .=
                    '
            <div class="col-sm-10">
                <textarea '.$disabled.' class="form-control ckeditor" placeholder="' . ucwords(($post['fCampo'][$i])) . '" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '">
            ...
            '
                                ...
                                case "INT":
                                    ...
                                    '
        <div class="form-group">
            <label for="'.$campoTabela.'" class="col-sm-2 control-label">'.ucwords(($tabelaRef)).$asterisco . '</label>
            <div class="col-sm-10">
                <select class="form-control select2" id="'.$campoTabela.'" name="'.$campoTabela.'" '.$validar.' '.$disabled.'>
        ...
        <div class="form-group">
            ...
            $edicao .=
                    '
            <div class="col-sm-10">
                <input type="text" '.$validar.' '.$disabled.' class="form-control pequeno" placeholder="' . ucwords(($post['fCampo'][$i])) . '" value="<?php if($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . ') echo $' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '["' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '"] ?>" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '">';
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" '.$validar.' '.$disabled.' class="form-control hora pequeno" placeholder="' . ucwords(($post['fCampo'][$i])) . '" value="<?php if($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . ') echo $' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '["' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '"] ?>" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '">';
            ...
            '
                                ...
                                case "SET":
                                    $edicao .=
                                    '
        <div class="form-group multiplo" label="' . ucwords(($post['fCampo'][$i])) . '">
            <label for="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" class="col-sm-2 control-label">' . ucwords(($post['fCampo'][$i])) . $asterisco . '</label>
            <div class="col-sm-10">';
            ...
            foreach($itemSet as $its){
                $edicao .= '
            <input type="radio" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" <?php if ($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '["' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '"] == "'.substr($its, 0, 1).'") echo "checked"; ?> id="'.strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))).$its.'" value="'.substr($its, 0, 1).'" validar="radio"> '.$its.' &nbsp;&nbsp;&nbsp;
            <!--<label for="'.strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))).$its.'" class="col-sm-2 control-label">'.$its.'</label>-->';
            }
            ...
            '
                                ...
                                case "IMAGEM":
                                    ...
                                    '
        <div class="form-group">
            <label for="' . strtolower(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" class="col-sm-2 control-label">' . ucwords(($post['fCampo'][$i])) . '</label>';
        ...
        <div class="form-group" id="div' . strtolower(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . 'Canvas" >
        ...
        if($post["fRegistro"] != "D"){
                                    ...
                                    '
        <div class="form-group">
            <label for="' . strtolower(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" class="col-sm-2 control-label">' . ucwords(($post['fCampo'][$i])) . $asterisco . '</label>';
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="' . ucwords(($post['fCampo'][$i])) . '" '.$validar.' '.$disabled.' value="<?php if($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . ') echo $' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '["' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '"] ?>" id="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '" name="' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '">';
...
//Adciona um novo texto
    ...
    <div class="operacoes">';
        ...
        $listagem .= '<a href="<?php echo url::base() ?>' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . '/edit" class="btn btn-default">Inserir</a>';
                    ...
                    <table class="table table-bordered table-mobile">
                        <thead>
                            <tr>';
                                ...
                                $listagem .= '<th  style="width: 10px"><input type="checkbox" class="seleciona" onclick="selecionar(this.checked)" valor="0"></th>';
                                //IF FREGISTRO IS EQUAL ONLY ONE OR DISABLED, FINISH COMMENT CODE
                                if($post["fRegistro"] == "O" or $post["fRegistro"] == "D"){
                                $listagem .= '-->';
                                }
                                */
                                $listagem .= '
                                    <th style="width: 70px">#
                                    <span><a href="#" onclick="ordenar(\'' . $carc . '_'.$id[0].'\', \'asc\')" class="seta-acima"></a>
                                        <a href="#" onclick="ordenar(\'' . $carc . '_'.$id[0].'\', \'desc\')" class="seta-abaixo"></a></span>
                                </th>';
                            if (array_key_exists('fCampo', $post)) {
                                if (is_array($post['fCampo'])) {
                                    $max = count($post['fCampo']);
                                ...
                                <th>' . ucwords(($post['fRef'][$i])) . '
                                    <span><a href="#" onclick="ordenar(\'' . $carcEst . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fDefault'][$i]))).'\', \'asc\')" class="seta-acima"></a>
                                        <a href="#" onclick="ordenar(\'' . $carcEst . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fDefault'][$i]))).'\', \'desc\')" class="seta-abaixo"></a></span>
                                </th>';
                                            }else{
                                                $listagem .= '
                            ...
                            if (count($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . ') > 0) {
                                foreach($' . strtolower(str_replace($separador, "", $this->trataTxt($post['fTabela']))) . ' as $' . strtolower($carc) . '){
                                    ...
                                    <tr>';
                                        ...
                                        */
                                        $listagem .= '<td><span class="label"># <?php echo $' . strtolower($carc) . '->' . $carc . '_'.$id[0].'; ?></span><span class="hide-mobile"><?php echo $' . strtolower($carc) . '->' . $carc . '_'.$id[0].'; ?></span></td>';
                            if (array_key_exists('fCampo', $post)) {
                                if (is_array($post['fCampo'])) {
                                    $max = count($post['fCampo']);
                                    for ($i = 0; $i < $max; $i++) {
                                        if ($post['fPesquisar'][$i] == "S" or $post['fRef'][$i] != "") {
                                            if($post['fRef'][$i] != ""){
                                                ...
                                                $listagem .= '
                                        <td><span class="label">'.ucwords(($post['fRef'][$i])).'</span><?php echo $' . strtolower($carc) . '->'. strtolower(str_replace($sep, "", $this->trataTxt($post['fRef'][$i]))). '->' . $carcEst . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fDefault'][$i]))) . '; ?></td>';
                                            }else{
                                                //SE FOR DATA, INVERTE
                                                if($post['fTipo'][$i] == "DATE"){
                                                $listagem .= '
                                        <td><span class="label">'.ucwords(($post['fCampo'][$i])).'</span><?php echo Controller_Index::aaaammdd_ddmmaaaa($' . strtolower($carc) . '->' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '); ?></td>';
                                                }else{
                                                $listagem .= '
                                        <td><span class="label">'.ucwords(($post['fCampo'][$i])).'</span><?php echo $' . strtolower($carc) . '->' . $carc . '_' . strtoupper(str_replace(" ", "_", $this->trataTxt($post['fCampo'][$i]))) . '; ?></td>';
                                                }
                                            }
                                        }
                                    }
