...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG SRC="<?php echo $dadosboleto["logoempresa"]; ?>"></td>
...
//     $tmp2 = substr($tmp2,0,strlen($tmp2)-1).'-'.substr($tmp2,strlen($tmp2)-1,1); Foi comentado para remover digito do convenio.
  ?>
